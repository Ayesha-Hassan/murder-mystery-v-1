"""
Murder Scenario: The Campsite Killing

This file contains the story and details for the camping murder mystery scenario.
"""
...
# Clues information with descriptions and locations
CLUES = [
    {
        "name": "Bloody Rock",
...
# Suspects information with alibis, testimonies, and guilt status
SUSPECTS = [
    {
        "name": "Alice Cooper", 
